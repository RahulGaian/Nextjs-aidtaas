      ...
      <article className="relative">
        ...
        <div className="media-wrapper mt-8 lg:mt-16">
          <iframe
            ...
            style={{ border: 0, height: 800, width: "100%" }}
            allowfullscreen=""
            loading="lazy"
        ...
        <div className="px-4 lg:px-0 mt-8 lg:mt-0">
          <footer
            className={
              Style.bgblur + " bg-blur lg:absolute top-0 z-10 p-9 lg:right-44"
            }
          >
              ...
              <li className="border-b border-royal-gray-200 py-8">
                <address className="flex not-italic">
                  ...
                  <div className="max-w-sm ml-4">
                    ...
                    <a
                      className="flex mt-3"
                      href="mailto:usaoffice@mobiusplatforms.com"
                    >
                      <Image
                        src="../public/images/icons/envelope.svg"
                        alt="Envelope Icon"
                        width={100}
                        height={100}
                      ></Image>
              ...
              <li className="py-8">
                <address className="flex not-italic">
                  ...
                  <div className="max-w-sm ml-4">
                    ...
                    <a
                      className="flex mt-3"
                      href="mailto:indiaoffice@mobiusplatforms.com"
                    >
                      <Image
                        src="../public/images/icons/envelope.svg"
                        alt="Envelope Icon"
