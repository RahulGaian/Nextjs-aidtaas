...
const ProductBanner = ({ bannerData }) => {
  return (
    <div className={st.container}>
      {/* <div className={`${st.container} ${st.bg_pink_blob_2} ${st.bg_blue_blob_1}`}> */}

      <div className={`${st.decoratorpb_b} ${st.bpos_2}`}></div>
      <div className={`${st.decoratorpb_p} ${st.bpos_3}`}></div>
